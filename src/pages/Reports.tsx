                ...
                <tbody>
                  {filtered.slice(0, 100).map((t, i) => (
                    <tr key={t.id} className="border-b last:border-0 hover:bg-muted/50">
                      ...
                      <td className="px-2 py-2"><span className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-full border ${t.priority === "Critical" ? "bg-red-100 text-red-800 border-red-300" : t.priority === "High" ? "bg-orange-50 text-orange-700 border-orange-200" : t.priority === "Medium" ? "bg-blue-50 text-blue-700 border-blue-200" : "bg-slate-50 text-slate-600 border-slate-200"}`}>{t.priority}</span></td>
